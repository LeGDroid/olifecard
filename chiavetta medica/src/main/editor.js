document.getElementById("fileLoader").onchange = function() {
	...
	var y = x.replace("editor.html","testi/");
	var h = y.replace("%20"," ");
	var z = h.substring(1);
	document.getElementById("dir").innerHTML ="<b>Save File in this directory:</b><br>" + z + " inside relative language folder" + "<br><b>With this name</b>";
